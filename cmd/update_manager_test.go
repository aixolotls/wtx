...
func TestShouldRunInvocationUpdateCheck(t *testing.T) {
	tests := []struct {
		...
		{name: "checkout command", args: []string{"wtx", "checkout", "main"}, want: false},
		{name: "checkout alias", args: []string{"wtx", "co", "main"}, want: false},
		{name: "pr command", args: []string{"wtx", "pr"}, want: false},
